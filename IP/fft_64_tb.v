...
initial
   begin
     ...
     fftpts_array[2]=64;
     fftpts_array[3]=16;
     data_rf = $fopen("fft_64_real_input.txt","r");
     data_if = $fopen("fft_64_imag_input.txt","r");
     fft_rf = $fopen("fft_64_real_output_ver.txt");
     fft_if =$fopen("fft_64_imag_output_ver.txt");
     fft_blksizef = $fopen("fft_64_blksize_report.txt");
     fft_inversef = $fopen("fft_64_inverse_report.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
